  ...
  return (
    <div id='image-viewer' className='flex flex-col justify-start w-screen h-[540px] sm:h-[640px] mobileLandscape:h-[440px] md:h-[640px] sm:px-16 mb-8 mt-4'>
        <div id='image-viewer' className='h-[500px] sm:h-[640px] mobileLandscape:h-[400px] md:h-[600px] flex flex-row items-center justify-between border-black/60 border'>
            ...
            {/* NEXT IMAGE BUTTON */}
            <button className='flex flex-col items-center justify-center w-[36px] h-[50px] rounded-l-full bg-[#f8f8f1] border-black border-y border-l sm:border-none sm:rounded-none sm:h-full absolute right-0 sm:static sm:w-[80px] sm:bg-transparent sm:hover:bg-gold transition duration-150 group z-10' onClick={handleShowNext}>
        ...
        <div className='text-white py-2 w-full sm:px-[36px] text-center bg-black/80'>{edieImages[imgIndex].description}</div>
    </div>
  )
}
