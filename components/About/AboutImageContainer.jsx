...
export default function AboutImageContainer({image, width, height, twcss, margin, float, description}) {
  return (
    <div className={`flex flex-col items-center h-auto p-3 bg-gradient-to-b from-slate-600 from-20% via-slate-500 via-80% to-slate-300 to-95% mx-auto w-auto mb-2 sm:float-${float} sm:${margin}`}>
