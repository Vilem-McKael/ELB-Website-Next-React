...
export default function NavBar({updateIsShowingSlideOutMenu, player, handleSetPlayer}) {
  return (
    <div className='flex w-full h-[120px] justify-between items-end fixed bg-gradient-to-b from-light7 from-60% to-[#f4f4eb] to-95% border-b-[1px] border-black text-black pl-8 pr-7 z-30'>
